...
public class ItemUse : MonoBehaviour {
	...
	void Awake () {
        ...
        for (int i = 0; i < items.Length; i++)
        {
            ...
            {
                items[i] = itemHand.transform.GetChild(i).transform.GetChild(0).gameObject;
                if (i != 0)
    ...
    public void UseItem()
    {
        Component weaponScript = equippedItem.GetComponent(equippedItem.transform.parent.name);
